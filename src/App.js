  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div id="main-content" className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white text-center mb-8">Scopri il Programma</h2>
          <AnimatedTabs />
        </div>

        {/* Day Selector */}
        <div className="max-w-md mx-auto mb-8">
          <h3 className="text-xl font-bold text-white text-center mb-6">Inizia Allenamento</h3>
